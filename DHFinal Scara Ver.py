...
class Scara(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(scara_img, (55, 68))
...
def show_new_scene():
    ...
    draw_text(screen, "Scara - We Did it.", 15, 10, 30)
    draw_text(screen, "WeirdoFairy - Well Done Scara. Well done!", 15, 10, 50)
    draw_text(screen, "Scara -  WeirdoFairy!!!", 15, 1, 70)
    draw_text(screen, "Scara - The Interdimension, its changing!", 15, 10, 100)
    draw_text(screen, "WeirdoFairy - AH! Its changing to its former united self!", 15, 10, 120)
    draw_text(screen, "Korei - Thank You Scara My sister's final wish camme true", 15, 10, 140)
    draw_text(screen, "But this time in the right way. Her truth Overpowered her darkness...", 15, 10, 160)
